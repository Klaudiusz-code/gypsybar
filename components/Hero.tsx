...
export default function Hero() {
  return (
    <section className="relative w-full h-[85vh] min-h-[600px] overflow-hidden bg-[#1b3745]">
      ...
      <div className="relative z-40 h-full max-w-[1400px] mx-auto w-full px-6 lg:px-16 flex flex-col justify-center">
        <div className="max-w-2xl animate-fadeUp">
          ...
          <h1 className="font-playfair text-4xl sm:text-5xl lg:text-6xl xl:text-7xl text-white font-bold leading-[1.05] mb-6">
            Twój osobisty
            <br />
            koktajlbar
            <br />
          ...
          <div className="flex flex-wrap gap-3 mb-10">
            <span className="border border-[#a28468]/30 text-[#a28468]/80 px-4 py-1.5 text-[10px] tracking-[0.2em] uppercase">
              Śluby
            </span>
            <span className="border border-[#a28468]/30 text-[#a28468]/80 px-4 py-1.5 text-[10px] tracking-[0.2em] uppercase">
              Imprezy Firmowe
          ...
          <div className="flex flex-wrap items-center gap-4">
            <a
              href="#oferta"
              className="group flex items-center gap-3 bg-[#a28468] text-[#1b3745] px-8 py-4 text-[11px] font-bold tracking-[0.15em] uppercase hover:bg-[#c4a882] transition-all duration-300 shadow-lg shadow-[#a28468]/30"
            >
            ...
            <a
              href="#kontakt"
              className="text-white/60 hover:text-white px-6 py-4 text-[11px] font-bold tracking-[0.15em] uppercase transition-all duration-300 underline underline-offset-4 decoration-[#a28468]/50 hover:decoration-[#a28468]"
            >
              Zapytaj o termin
            </a>
          </div>
