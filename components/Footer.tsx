...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#080f13] overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-px bg-[#a28468]/10" />

      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1/3 h-px bg-gradient-to-r from-transparent via-[#a28468]/50 to-transparent shadow-[0_0_15px_rgba(162,132,104,0.3)]" />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-8 md:py-6">
        <div className="flex flex-col items-center text-center md:grid md:grid-cols-3 md:items-center md:text-left gap-6 md:gap-0">
          ...
          <div className="hidden md:flex justify-center items-center gap-4">
            ...
            <div className="w-1.5 h-1.5 rotate-45 border border-[#a28468]/30" />
