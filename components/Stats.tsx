export default function Stats({ data }: any) {
  ...
  // Funkcja pomocnicza sprawdzająca aktualny język (zakładam Next.js App Router)
  const getLocale = () => {
    if (typeof window !== "undefined") {
      return window.location.pathname.startsWith("/en") ? "/en" : "";
    }
    return ""; // Fallback dla SSR
  };
      ...
      <div className="max-w-4xl mx-auto">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-0 lg:divide-x lg:divide-[#a28468]/15">
          {data.statsItems.map((stat: any, i: any) => {
            // Sprawdzamy, czy to ostatni element (100% satysfakcji)
            ...
            return (
              ...
              >
                ...
                {/* CTA tylko dla ostatniego kafelka */}
                {isLast && (
                  <a
                    href={`${getLocale()}https://share.google/f5C5DdSvH35VP6s2h`}
                    target="_blank"
